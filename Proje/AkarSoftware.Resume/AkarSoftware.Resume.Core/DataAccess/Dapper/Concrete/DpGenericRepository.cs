using AkarSoftware.Resume.Core.DataAccess.Dapper.Abstract;
using AkarSoftware.Resume.Core.Entities.Abstract;
using Dapper.Contrib.Extensions;
using System.Data;

namespace AkarSoftware.Resume.Core.DataAccess.Dapper.Concrete
{
    public class DpGenericRepository
    {
        public class GenericRepository<T> : IDpGenericRepository<T> where T : class, IEntity, new()
        {
